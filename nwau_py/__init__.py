...
__all__ = [
    ...
    "jurisdiction_funding_model_registry",
...
_LAZY_ATTRS = {
    ...
    "nsw_funding_model": (".nsw_funding_model", None),
    "NSWFundingModelError": (".nsw_funding_model", "NSWFundingModelError"),
    "NSWFundingModelRecord": (".nsw_funding_model", "NSWFundingModelRecord"),
    "NSWFundingModelRegistry": (".nsw_funding_model", "NSWFundingModelRegistry"),
    "NSWFundingModelStatus": (".nsw_funding_model", "NSWFundingModelStatus"),
    "get_nsw_state_price": (".nsw_funding_model", "get_nsw_state_price"),
    "apply_parallel_nsw_valuation": (
        ".nsw_funding_model",
        "apply_parallel_nsw_valuation",
    ),
