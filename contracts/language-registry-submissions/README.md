...
Remaining blockers are publisher agreement/account setup for Open VSX and Visual Studio Marketplace, Central Portal namespace/signing for Maven Central, upstream maintainer review workflows, public listing/index propagation, full Conan/vcpkg validation tooling, or unavailable local proprietary runtimes such as MATLAB/Stata.
