...
- Branch update: GitHub accepted an update-branch request on 2026-05-26. Latest poll: PR head `e6c8b9d632953263517de6a146783f3697fc450d`; linter, check-skip, and linux_64 succeeded; osx_64, win_64, and aggregate staged-recipes were still in progress or queued, so completion is not yet claimed for this head.
- Remaining step: wait for osx_64/win_64/aggregate staged-recipes checks on the latest head, then conda-forge staged-recipes review, merge, and feedstock publication.
