...
- Branch update: GitHub accepted another update-branch request on 2026-05-26. Latest poll: PR head `04452d8f9b839493acedbabf198140b562648ac9`; linter passed and Azure platform builds are rerunning.
- Remaining step: conda-forge staged-recipes platform builds, review, merge, and feedstock publication.
