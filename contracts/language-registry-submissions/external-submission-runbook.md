...
- ConanCenter PR state: submitted and waiting on maintainer job-scheduler approval plus CLA Assistant legal acceptance before upstream CI/publication can be claimed. Maintainer job request posted at `https://github.com/conan-io/conan-center-index/pull/30262#issuecomment-4535445528`; CLAassistant reports the CLA as pending/not signed and requires authorized contributor legal acceptance.
