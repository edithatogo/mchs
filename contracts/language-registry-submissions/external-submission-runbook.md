...
- ConanCenter PR state: submitted and waiting on maintainer job-scheduler approval before upstream CI/publication can be claimed. Maintainer job request posted at `https://github.com/conan-io/conan-center-index/pull/30262#issuecomment-4535445528`; CLAassistant now reports the ConanCenter CLA as pending/not signed, which requires authorized contributor legal acceptance.
