...
{pstd}Dylan Mordaunt{p_end}

{pstd}Maintainer contact: {browse "mailto:dylan.mordaunt@vuw.ac.nz":dylan.mordaunt@vuw.ac.nz}{p_end}

{pstd}Repository: {browse "https://github.com/edithatogo/mchs":https://github.com/edithatogo/mchs}{p_end}
