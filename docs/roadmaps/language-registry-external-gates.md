...
| Open VSX / Visual Studio Marketplace | `mchs-tools` | extension source scaffold committed; manifest is publisher-ready; VSIX rebuild on 2026-06-12 produced SHA-256 `73db22882af022750ce7846ecd687dea0b7d383a12f6e9767a7eadbd63f1e4ef`; generated `.vsix` intentionally not committed | Open VSX still reports no Eclipse Publisher Agreement after GitHub login and an Eclipse OAuth attempt; needs valid `OVSX_PAT`. Visual Studio Marketplace publisher/PAT access remains unresolved |
