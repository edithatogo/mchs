...
| CRAN | `nwauR` | 2026-06-12T12:29:29Z temp-directory `R CMD build` and `R CMD check --no-manual` passed with `Status: OK`; generated tarball SHA-256 `12d6fd831a202ed9a480a36e64ac01f7410296d0bc3a5aae75dccdebaadd19d2`; 2026-06-12T12:18:08Z CRANDB, CRAN package page, and CRAN archive probes all returned 404 | CRAN maintainer submission and review |
