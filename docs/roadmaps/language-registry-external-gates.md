...
| CRAN | `nwauR` | 2026-06-12T13:34:54Z temp-directory `R CMD build` and `R CMD check --as-cran` completed with `Status: 2 NOTEs`; `.Rbuildignore` now excludes `cran-comments.md`; generated tarball SHA-256 `a081781f26e2652bc085e0e852399a180ac6a2187684e8c0cec5d8448b80e9cc`; public CRAN probes still returned 404 | Replace placeholder maintainer email, then CRAN maintainer submission/review |
