...
| Julia General | `NationalWeightedActivityUnitWrapper` | reviewer-requested replacement PR #156254 is open; registry consistency, treecheck, AutoMerge, and AutoMerge-stopwatch checks pass; superseded PRs are closed; reviewer `[noblock]` clarification answered that "National" refers to Australia's NWAU context | General PR #156254 mandatory wait, merge, and public registry propagation |
