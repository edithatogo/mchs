...
| Maven Central | `io.github.edithatogo:mchs` | JVM module builds locally; Maven publishing metadata and Central Portal repository wiring present; GitHub Actions dry-run `https://github.com/edithatogo/mchs/actions/runs/27407884659` passes after setting workflow JDK 17 for Gradle 9 | namespace verification, signing credentials, publish credentials, Central Portal release |
