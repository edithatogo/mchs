...
| conda-forge | `nwau-py` | PR `https://github.com/conda-forge/staged-recipes/pull/33452` is open; GitHub branch update succeeded on 2026-05-26 and latest head is `8e479175a4e9feffcd4e5313ef149abb485f1343`; linter/check jobs are rerunning after the update | checks returning green, maintainer review, merge, feedstock publication, and public Anaconda propagation |
