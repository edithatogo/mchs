...
| CRAN | `nwauR` | `R CMD build` and `R CMD check` passed; 2026-06-12T12:18:08Z CRANDB, CRAN package page, and CRAN archive probes all returned 404; local R is available at `/opt/homebrew/bin/R`, but the generated tarball is not committed in the checkout | CRAN maintainer submission and review |
