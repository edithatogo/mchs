...
| Kotlin/JVM and Kotlin/Native | JVM package plus Native artifact over C ABI, service, or file contract | Maven Central publication verified for `io.github.edithatogo:mchs-jvm-bindings:0.1.0`; public JAR SHA-256 `2f499b78d06317fd9bf2e343542b74043f163f127cd32db4651098f6ac6af49e`; Kotlin/Native remains local adapter evidence only | `preview` for JVM package; `private` for Kotlin/Native artifact publication | Release when the Kotlin adapters stay thin, CI covers the supported target range, and namespace/public-key evidence remains reproducible for published JVM artifacts. |
