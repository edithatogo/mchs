# Plan: recursive sota contract audit
...
- [x] Task: Repair metadata.json to record a governance-only complete-with-gaps support scope, completion policy, archive evidence, and explicit current-audit-output gaps.
...
- [x] Task: Add focused validation for archive metadata, plan checkpoints, recursive audit requirements/design contract, and archived registry status.
