# Plan: conductor requirements design authority
...
- [x] Task: Repair metadata.json to record a structured support scope, completion policy, archive evidence, and explicit gap register.
- [x] Task: Repair plan.md to preserve phase checkpoints and state that this governance track does not complete every dependent implementation track.
- [x] Task: Add focused validation that checks the requirements/design authority documents, archive metadata contract, plan checkpoints, and archived registry link.
