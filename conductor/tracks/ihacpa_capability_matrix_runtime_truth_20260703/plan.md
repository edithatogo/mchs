...
- [ ] Task: Add failing tests for generated support statuses across CLI, MCP/API, and docs fixtures.
- [ ] Task: Define drift checks for committed generated capability artifacts.
