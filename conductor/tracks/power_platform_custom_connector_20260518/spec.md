# Specification: Power Platform Custom Connector

## Overview

Create the custom connector package and OpenAPI definition for the MCHS service boundary.
...
- `power_platform_service_boundary_api_20260518`
...
- A source-controlled custom connector can be packed into the solution and imports cleanly with connection references and environment variables.
