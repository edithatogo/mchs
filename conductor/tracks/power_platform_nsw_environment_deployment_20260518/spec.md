# Specification: Power Platform NSW Environment Deployment

## Overview

Deploy the managed solution to the target NSW Power Platform environment and record tenant/environment evidence.
...
- `power_platform_alm_ci_cd_20260518`
...
- The solution is imported into the NSW environment with configured connection references, environment variables, and smoke-test evidence.
