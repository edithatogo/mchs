# Specification: Power Platform App Surface

## Overview

Create the user-facing Power Platform app surface that orchestrates connector calls and presents diagnostics without performing calculator logic.
...
- A canvas or model-driven app is included in the solution, uses the custom connector, and contains no duplicated calculation formulas.
