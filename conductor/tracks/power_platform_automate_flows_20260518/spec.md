# Specification: Power Automate Orchestration Flows

## Overview

Create Power Automate flows for validation, calculation orchestration, evidence export, and deployment smoke checks.
...
- Flows are solution-aware, call the custom connector only, log correlation IDs, and do not duplicate calculator logic.
