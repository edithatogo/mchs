...
slug: 2026/governance/reference-data-manifests
---
...
[Conductor spec](https://github.com/edithatogo/microcosting_healthservices/blob/master/conductor/archive/reference_data_manifest_schema_20260512/spec.md)
and [CI notes](https://github.com/edithatogo/microcosting_healthservices/blob/master/conductor/archive/reference_data_manifest_schema_20260512/ci_notes.md).
...
Use the public [calculator coverage matrix](/2026/governance/calculator-coverage/)
