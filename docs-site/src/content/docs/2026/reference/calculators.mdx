...
slug: 2026/reference/calculators
---
...
The support status shown across the repo is generated from
`contracts/support/calculator-capability-matrix.json`; the calculator pages and
runtime surfaces should be read as views over that matrix.
...
`conductor/ihacpa-tool-coverage-matrix.md`.
